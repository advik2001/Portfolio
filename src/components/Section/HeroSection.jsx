				...
				<div className='max-w-7xl mx-auto w-full z-10 mt-20'>
					...
					<div className='block lg:hidden'>
						...
						>
							...
							>
								{[
									{ icon: FiGithub, href: 'https://github.com/advik2001' },
									{ icon: FiLinkedin, href: 'https://www.linkedin.com/in/contact-advik-gupta/' },
									{ icon: Mail, href: 'mailto:guptaadvik187@gmail.com' },
								].map((social, index) => (
									<motion.a
										key={index}
										target="_blank"
